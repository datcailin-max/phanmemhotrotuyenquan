...
// Chỉ 4 danh sách 1, 2, 3, 4 được phép nhập tự động từ file Excel
export const EXCEL_IMPORT_ALLOWED_TAB_IDS = [
  'NOT_ALLOWED_REG', // 1. DS KHÔNG ĐƯỢC ĐĂNG KÝ NVQS
  'EXEMPT_REG',      // 2. DS ĐƯỢC MIỄN ĐK NVQS
  'FIRST_TIME_REG',  // 3. DS ĐĂNG KÝ NVQS LẦN ĐẦU
  'ALL'              // 4. TOÀN BỘ NGUỒN
] as const;
...
export const TABS = [
  ...
  { id: 'TT50', label: '5. DS KTC, CGNN', status: [RecruitmentStatus.NOT_SELECTED_TT50, RecruitmentStatus.KTC_KHONG_TUYEN_CHON, RecruitmentStatus.KTC_CHUA_GOI_NHAP_NGU], color: 'bg-slate-600', lightColor: 'bg-slate-200', borderColor: 'border-slate-600', textColor: 'text-slate-900', icon: BookX },
  { id: 'KTC_SUB1', label: '5.1. KHÔNG TUYỂN CHỌN', status: [RecruitmentStatus.KTC_KHONG_TUYEN_CHON], color: 'bg-slate-500', lightColor: 'bg-slate-50', borderColor: 'border-slate-500', textColor: 'text-slate-700', icon: UserMinus, isSub: true, parentId: 'TT50' },
  { id: 'KTC_SUB2', label: '5.2. CHƯA GỌI NHẬP NGŨ', status: [RecruitmentStatus.KTC_CHUA_GOI_NHAP_NGU], color: 'bg-slate-500', lightColor: 'bg-slate-50', borderColor: 'border-slate-500', textColor: 'text-slate-700', icon: UserSearch, isSub: true, parentId: 'TT50' },
  ...
  { id: 'ENLISTED', label: '11. DS NHẬP NGŨ NĂM X', status: [RecruitmentStatus.ENLISTED], color: 'bg-red-600', lightColor: 'bg-red-50', borderColor: 'border-red-600', textColor: 'text-red-900', icon: Flag },
  ...
  { id: 'REMOVED_MILITARY_SCHOOL', label: '12.1. ĐANG HỌC TRƯỜNG QUÂN ĐỘI', status: [RecruitmentStatus.REMOVED_FROM_SOURCE], color: 'bg-gray-500', lightColor: 'bg-gray-50', borderColor: 'border-gray-500', textColor: 'text-gray-700', icon: GraduationCap, isSub: true, parentId: 'REMOVED' },
  { id: 'REMOVED_TRANSFERRED', label: '12.2. CHUYỂN HỘ KHẨU', status: [RecruitmentStatus.REMOVED_FROM_SOURCE], color: 'bg-gray-500', lightColor: 'bg-gray-50', borderColor: 'border-gray-500', textColor: 'text-gray-700', icon: UserX, isSub: true, parentId: 'REMOVED' },
  { id: 'REMOVED_OTHER', label: '12.3. LÝ DO KHÁC', status: [RecruitmentStatus.REMOVED_FROM_SOURCE], color: 'bg-gray-500', lightColor: 'bg-gray-50', borderColor: 'border-gray-500', textColor: 'text-gray-700', icon: UserX, isSub: true, parentId: 'REMOVED' },
