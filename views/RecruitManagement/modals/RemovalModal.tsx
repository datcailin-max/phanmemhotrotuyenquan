  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[100] p-4 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl animate-in zoom-in duration-300">
        <h3 className="font-black text-lg text-military-900 uppercase tracking-tight mb-2 flex items-center gap-2"><UserX className="text-red-600"/> Loại khỏi danh sách nguồn</h3>
        <p className="text-xs text-gray-500 mb-4 font-medium italic">* Vui lòng ghi rõ lý do loại (Chuyển HK, đã đi nghĩa vụ trước đó, vi phạm pháp luật...)</p>
        <textarea 
