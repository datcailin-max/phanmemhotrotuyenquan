        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
             ...
             />
              <Card 
                 ...
                 detailText={`${stats.countMedPass} Đạt / ${stats.countMedFail} Loại${(stats.countPreCheckPass - stats.countMedPass - stats.countMedFail) > 0 ? ` / ${stats.countPreCheckPass - stats.countMedPass - stats.countMedFail} Chưa khám` : ''}`} 
              />
